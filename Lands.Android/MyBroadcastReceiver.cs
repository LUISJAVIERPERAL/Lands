    ...
    public class PushHandlerService : GcmServiceBase
    {
        ...
        protected override void OnMessage(Context context, Intent intent)
        {
            ...
            if (!string.IsNullOrEmpty(message))
            {
                ...
                createNotification("Comocomen APP nuevo aviso", string.Format("{0}", message));
            }
        }
        ...
        protected override void OnRegistered(Context context, string registrationId)
        {
            ...
            if (mainviewModel.Mitoken != null)
            {
                var userId = mainviewModel.Mitoken.Cod_alumf;
        ...
        void createNotification(string title, string desc)
        {
            ...
            var notification = new Notification(Android.Resource.Drawable.IcMenuAgenda, title);
        ...
        protected void dialogNotify(String title, String message)
        {
            ...
            mainActivity.RunOnUiThread(() =>
            {
                ...
                alert.SetIcon(Resource.Drawable.iconos);
